...
async function fetchDigestPreferences(userEmail) {
  ...
  try {
    const response = await base44.functions.invoke('elora_get_digest_preferences', { userEmail });
...
async function saveDigestPreferences(preferences) {
  const response = await base44.functions.invoke('elora_save_digest_preferences', preferences);
